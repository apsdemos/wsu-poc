import{g as L}from"../chunks/aem-D3RMVdVl.js";function y(a){const e=document.createElement("div");e.classList.add("hero__contents");const t=document.createElement("ul");t.classList.add("hero__tabs"),[...a.children].forEach(c=>{const n=c.querySelectorAll("div"),l=n[0],d=n[1],i=d.querySelector("a"),_=l.querySelector("picture"),h=i?i.href:"",u=i?i.innerText:d.innerText.trim(),v=Array.from(d.querySelectorAll("p")).slice(1).map(b=>b.innerText.trim()).join(" "),r=document.createElement("div");r.classList.add("hero__tab-content"),r.innerHTML=`
